...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> <?php echo $action == 'add'?'New':'Edit';?> Stream<hr /></h3>
            ...
            <div class="col-md-12">
            	...
            	<form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" name="course_id" id="course_id">
                                ...
                                <?php foreach ($arr_country as $key => $country) { ?>
                                    <option <?php echo($country->id==$row['course_id'])?'selected':''; ?>
                    ...
                    <div class="form-group <?php echo form_error('min_price')?'has-error':'';?>">
                        <label class="col-md-2 control-label" for="min_price">Min Price<span class="required" aria-required="true"> * </span></label>
                        <div class="col-md-5">
                            <input type="text" name="min_price" placeholder="min_price" id="min_price" class="form-control" value="<?php echo $row['min_price'];?>">
                            <?php echo form_error('min_price');?>
                        </div>
                    </div>

                    <div class="form-group <?php echo form_error('max_price')?'has-error':'';?>">
                        <label class="col-md-2 control-label" for="max_price">Max Price<span class="required" aria-required="true"> * </span></label>
                        <div class="col-md-5">
                            <input type="text" name="max_price" placeholder="max_price" id="max_price" class="form-control" value="<?php echo $row['max_price'];?>">
