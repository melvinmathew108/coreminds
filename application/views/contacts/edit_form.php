    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select id="stream_id"
                ...
                <?php foreach($arr_stream as $key => $item ){

                    $name = $item->name.' ( '.$item->min_price.' - '.$item->max_price.' ) ';

                    ?>
                    <option value="<?php echo $item->id; ?>" <?php echo ($row['stream_id']== $item->id)?"selected":''; ?>>
                        <?php echo  $name; ?>
                    </option>
                <?php } ?>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>Parents/Guardian  Phone</label>
